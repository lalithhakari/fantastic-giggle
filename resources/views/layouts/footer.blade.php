        ...
        <div class="lg:w-1/2">
                    ...
                    <div>
                        <form>
                            <div class="flex w-full flex-wrap items-stretch gap-4">
                                <label class="flex min-w-[240px] flex-1 items-center bg-white">
            ...
            <div class="mt-10 flex flex-wrap items-center gap-8">
                ...
                <div class="flex flex-wrap items-center gap-2 sm:flex-nowrap">
                    <x-svg-icon icon="solid/linkedin" title="Dark Mode" class="w-7 h-7" />
                    <x-svg-icon icon="solid/youtube" title="Dark Mode" class="w-7 h-7" />
                </div>
            </div>
        </div>
